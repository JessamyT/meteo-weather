...
This module implements the [Viam sensor API](https://docs.viam.com/dev/reference/apis/components/sensor/) in a `jessamy:meteo-weather:meteo_PM` model.
...
Click the **+** button, select **Component**, then select the `sensor / weather:meteo_PM` model provided by the [`meteo-weather` module](https://app.viam.com/module/jessamy/meteo-weather).
